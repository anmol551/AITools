...
Caption: Figure 5.X — <full caption sentence describing the figure in context; one liner>
...
- X is a globally incrementing integer. The starting value for X is provided to you
  at the top of each prompt as FIGURE_START. Begin from that number and increment
  from there across the ENTIRE section. Never reset to 1.
...
- Do NOT output any Markdown heading symbols (#, ##, ###, etc.). Write all headings as plain text.
"""
